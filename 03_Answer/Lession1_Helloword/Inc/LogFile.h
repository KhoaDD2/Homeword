...
#define LOGI(xx_fmt,...) printf("[Infor][File %s :Line %d ] Context: %s\r\n",__FILE__,__LINE__, xx_fmt,##__VA_ARGS__)
#define LOGW(xx_fmt,...) printf("[Warning][File %s :Line %d ] Context: %s\r\n",__FILE__,__LINE__, xx_fmt,##__VA_ARGS__)
#define LOGE(xx_fmt,...) printf("[Error][File %s :Line %d ] Context: %s\r\n",__FILE__,__LINE__, xx_fmt,##__VA_ARGS__,##__VA_ARGS__)
